<template>
  ...
  <div class="flex align-center space-between list-item-container" style="width: 493px; margin-bottom: 15px" v-if="!checkListItem.isBeingEdited" @click=" log(checkListItem)">
