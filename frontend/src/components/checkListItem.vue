<template>
  ...
  <div class="flex align-center space-between list-item-container" style="width: 88%; margin-bottom: 15px" v-if="!checkListItem.isBeingEdited" >
        ...
        <form v-if="checkListItem.isBeingEdited" action="">
                <el-input  style="width: 90%" placeholder="New task name" v-model="checkListItem.txt"></el-input>
